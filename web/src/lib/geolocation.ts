...
// address so the backend's distance-based collection fee (haversine vs PRIMARY_LAB_LAT/LNG)
// can actually run instead of always falling back to "not calculable".
